...
function openCardComposer(list, ul, addBtn) {
  ...
  // card front (title over subtitle). autocomplete/autocorrect off so the
  // browser doesn't prefill the fields with previous entries.
  wrap.innerHTML = `
    <div class="composer-card">
      <input type="text" class="composer-name" placeholder="Name"
             autocomplete="off" autocorrect="off" autocapitalize="words" spellcheck="false" />
      <input type="text" class="composer-calling" placeholder="Calling"
             autocomplete="off" autocorrect="off" autocapitalize="words" spellcheck="false" />
    </div>
